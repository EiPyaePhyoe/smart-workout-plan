...
router.get("/adminlogin", function(req, res){
 ...
 router.get("/workouts", async function (req, res){
  const workouts = await Workout.find({isDeleted: false}).populate("createdBy","name");
 ...
 router.get("/challenge/:id", async function (req, res){
  var challenge= await Challenge.findById(req.params.id).populate("workoutId", "title");
